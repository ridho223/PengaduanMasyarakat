...
<div class="d-flex justify-content-start">
    <div class="bg-white p-5 rounded-4 shadow-lg fw-bold" style="width: 1300px;">
        <h3 class="text-center mb-4" style="color: #666;">Edit Data Admin</h3>
...
<script>
    ...
    const myDropzone = new Dropzone("#dropzone", {
        url: "{{ route('admin.resident.upload', ['id' => $admin->id]) }}",
        paramName: "file",
        maxFiles: 1,
        acceptedFiles: 'image/*',
        addRemoveLinks: true,
        ...
        init: function () {
            ...
            let oldAvatar = "{{ $admin->avatar ? asset('storage/' . $admin->avatar) : '' }}";

            if (oldAvatar) {
                let mockFile = { name: "{{ $admin->avatar }}", size: 12345, type: 'image/jpeg' };
