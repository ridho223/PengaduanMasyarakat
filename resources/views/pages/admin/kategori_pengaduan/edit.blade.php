...
<div class="d-flex justify-content-start ">
    <div class="bg-white p-5 rounded-4 shadow-lg fw-bold" style="width: 1300px;">
        <h3 class="text-center mb-4" style="color: #666;">Edit Data Kategori Pengaduan</h3>
        <form action="{{ route('admin.kategori_pengaduan.update', $kategori->id) }}" method="POST"
            ...
            <div class="mb-3 col-md-10">
                ...
                <input type="text" class="form-control" name="nama" value="{{ old('name', $kategori->nama) }}" required>
                @error('nama')
