...
<div>
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h2 class="m-0 font-weight-bold ">Data Masyarakat</h2>
            <a href="{{ route('admin.resident.create') }}" class="btn btn-secondary">Tambah Data</a>
        </div>
                        ...
                        @foreach ($residents as $resident)                        
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <a href="{{ route('admin.resident.edit', $resident->id) }}" class="text-success">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('admin.resident.destroy', $resident->id) }}" method="POST"
                                        class="d-inline" id="delete-form-{{$resident->id  }}">
                                        @csrf
                                        @method('DELETE')
